...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodGet, "/v1/search/youtube/:query", app.requirePermission("recommendations:write", app.searchYoutubeHandler)) // TODO add search:read permission
	router.HandlerFunc(http.MethodGet, "/v1/search/spotify/:query", app.requirePermission("recommendations:write", app.searchSpotifyHandler)) // TODO add search:read permission

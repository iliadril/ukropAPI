...
// comment directive in the format `//go:embed <path>`indicates to Go that we want to store the contents of the ./templates directory in the templateFS embedded file system variable.
